...
class logInspectorInternal(LogInspectorWindow):
    ...
    def createButtonColumn(self):
        ...
        self.addButton('RTK Dbg 2 SNR', lambda: self.plot('rtkDebug2Snr'))
        self.addButton('RTK Dbg 2 LPD', lambda: self.plot('rtkDebug2LPD'))
        self.addButton('RTK Dbg 2 LLI', lambda: self.plot('rtkDebug2LLI'))
